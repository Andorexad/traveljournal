...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    fileprivate func setupFetchedResultsController() {
        ...
        fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: self.dataController.viewContext, sectionNameKeyPath: nil, cacheName: "\(place)-notebooks")
    ...
    func addNotebook(name: String) {
        let notebook = Notebook(context: self.dataController.viewContext)
        notebook.name = name
        notebook.creationDate = Date()
        notebook.places=place
        print(notebook)
//        self.dataController.viewContext.save()
//        print(fetchedResultsController.fetchedObjects)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        }else if let vc = segue.destination as? imageCollectionViewController {
            vc.place = place
            vc.dataController = self.dataController
